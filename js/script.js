...
// * Vite стає все більш популярним у середовищі фронтенд-розробників завдяки своїй швидкості та простоті використання. Він дозволяє розробляти ефективні та модульні вебдодатки, зосереджуючись на тому, що важливо — функціональності.
...
/*
    ...
    і from — на шлях до модуля з імпортованою сутністю
...
// * Іменований імпорт може бути корисним, коли є багато значень для експорту з одного модуля, і потрібно контролювати, які саме значення будуть імпортовані в іншому файлі. Без додаткових конструкцій не можна іменованим імпортом імпортувати сутність з іншого модуля, якщо вона в ньому була експортована за замовчуванням. Тобто іменований експорт імпортуємо тільки за допомогою іменованих імпортів.
